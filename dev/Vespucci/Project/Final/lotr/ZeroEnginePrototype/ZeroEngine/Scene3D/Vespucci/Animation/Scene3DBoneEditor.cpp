...
//
// Pandemic's animators had Maya/3DS + Havok Content Tools for this.
...
// bone's world-space axes same technique used in Maya's/3DS rotate
// manipulator. I didn't copy Maya's/3DS code. I copied the IDEA and
// then spent a week debugging gimbal lock edge cases that Maya/3DS
...
// the skeleton drifted into a pose that looked like modern art bullshit.
// ============================================================================
...
{
    m_passStats[STAT_SKELETON].drawCalls = 0;
    m_passStats[STAT_SKELETON].triangles = 0;
    m_passStats[STAT_SKELETON].meshPartsDrawn = 0;
    ...
    m_context->endGroup();
    m_passStats[STAT_SKELETON].drawCalls++;
